package com.ironaviation.traveller.map.overlayutil;
...
public class DrivingRouteOverlay extends OverlayManager {
     ...
     */
    public DrivingRouteOverlay(BaiduMap baiduMap, Context mContext) {
        super(baiduMap);
           ...
           /* for (DrivingRouteLine.DrivingStep step : mRouteLine.getAllStep()) {
                ...
                if (step.getEntrance() != null) {
                    overlayOptionses.add((new MarkerOptions())
                            ...
                            .extraInfo(b)
                            .icon(getLineNodeMarker() != null ? getLineNodeMarker() :
...
//            }
            ...
            PolylineOptions option = new PolylineOptions()
                    ...
                    .focus(true)
                    .color(getLineColor() != 0 ? getLineColor() : Color.argb(255, 29, 190, 78)).zIndex(0);
            if (isDotLine) {
                //option.customTextureList(getCustomTextureList());

                option.customTexture(BitmapDescriptorFactory.fromAsset("Icon_road_green_arrow.png"));
     ...
     * @return 起点图标
     */
    public BitmapDescriptor getLineNodeMarker() {
