...
@ActivityScope
@Component(modules = InvalidationModule.class, dependencies = AppComponent.class)
public interface InvalidationComponent {
    void inject(InvalidationActivity activity);
}