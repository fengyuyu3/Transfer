...
@ActivityScope
@Component(modules = TravelDetailsOnModule.class, dependencies = AppComponent.class)
public interface TravelDetailsOnComponent {
    void inject(TravelDetailsOnActivity activity);
}