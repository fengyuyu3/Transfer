 ...
 * 类描述：   
 * 创建人：starRing  
 * 创建时间：2017-04-05 14:26   
 * 修改人：starRing  
 * 修改时间：2017-04-05 14:26   
 * 修改备注：   
 * @version
 *
 */
@ActivityScope
@Component(modules = TravelCancelModule.class, dependencies = AppComponent.class)
public interface TravelCancelComponent {
    void inject(TravelCancelActivity activity);
}