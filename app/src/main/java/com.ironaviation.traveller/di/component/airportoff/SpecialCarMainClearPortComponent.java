...
@ActivityScope
@Component(modules = SpecialCarMainClearPortModule.class, dependencies = AppComponent.class)
public interface SpecialCarMainClearPortComponent {
    void inject(SpecialCarMainClearPortFragment activity);
}