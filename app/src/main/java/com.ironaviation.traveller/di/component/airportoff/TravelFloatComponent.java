...
@ActivityScope
@Component(modules = TravelFloatModule.class, dependencies = AppComponent.class)
public interface TravelFloatComponent {
    void inject(TravelFloatActivity activity);
}