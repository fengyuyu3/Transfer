...
@ActivityScope
@Component(modules = VerifyIdCardModule.class, dependencies = AppComponent.class)
public interface VerifyIdCardComponent {
    void inject(VerifyIdCardActivity activity);
}