...
import com.ironaviation.traveller.mvp.model.payment.ChargeMoneyModel;
...
public class ChargeMoneyModule {
    ...
    /**
     * 构建ChargeMoneyModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    ChargeMoneyContract.View provideChargeMoneyView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    ChargeMoneyContract.Model provideChargeMoneyModel(ChargeMoneyModel model) {
        return model;
    }
}