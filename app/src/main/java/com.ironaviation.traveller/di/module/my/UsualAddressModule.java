...
import com.ironaviation.traveller.mvp.model.my.UsualAddressModel;
...
public class UsualAddressModule {
    ...
    @ActivityScope
    @Provides
    UsualAddressContract.View provideUsualAddressView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    UsualAddressContract.Model provideUsualAddressModel(UsualAddressModel model) {
        return model;
    }
}