...
public class AutoSwipeMenuRecyclerView extends SwipeMenuRecyclerView {
    ...
    public AutoSwipeMenuRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AutoSwipeMenuRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public static class LayoutParams extends SwipeMenuRecyclerView.LayoutParams
