 ...
 * 修改备注：
 */
public class TravelCancelAdapter extends BaseQuickAdapter<TravelCancelResponse, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, TravelCancelResponse item) {
