...
@ActivityScope
public class ChargeMoneyModel extends BaseModel<ServiceManager, CacheManager> implements ChargeMoneyContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ChargeMoneyModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
