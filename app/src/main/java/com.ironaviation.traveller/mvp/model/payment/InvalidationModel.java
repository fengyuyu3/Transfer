...
@ActivityScope
public class InvalidationModel extends BaseModel<ServiceManager, CacheManager> implements InvalidationContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public InvalidationModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
