...
@ActivityScope
public class SpecialCarMainClearPortModel extends BaseModel<ServiceManager, CacheManager> implements SpecialCarMainClearPortContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public SpecialCarMainClearPortModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
