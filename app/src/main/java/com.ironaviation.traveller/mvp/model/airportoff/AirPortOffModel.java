 ...
 * 类描述：   
 * 创建人：flq  
 * 创建时间：2017/3/27 18:14   
 * 修改人：  
 * 修改时间：2017/3/27 18:14   
 * 修改备注：   
 * @version
 *
 */
...
@ActivityScope
public class AirPortOffModel extends BaseModel<ServiceManager, CacheManager> implements AirPortOffContract.Model {
    private Gson mGson;
    private Application mApplication;
    private CommonService mCommonService;

    @Inject
    public AirPortOffModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
