...
@ActivityScope
public class SpecialCarMainModel extends BaseModel<ServiceManager, CacheManager> implements SpecialCarMainContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public SpecialCarMainModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
