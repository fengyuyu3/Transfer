...
@ActivityScope
public class VerifyIdCardModel extends BaseModel<ServiceManager, CacheManager> implements VerifyIdCardContract.Model {
    private Gson mGson;
    private Application mApplication;
    private CommonService mCommonService;

    @Inject
    public VerifyIdCardModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<BaseData<AirportGoInfoRequest>> getHasBookInfo(AirportGoInfoRequest params) {
        return mCommonService.getHasBookInfo(params);
    }
}
