...
@ActivityScope
public class TravelFloatOnModel extends BaseModel<ServiceManager, CacheManager> implements TravelFloatOnContract.Model {
    private Gson mGson;
    private Application mApplication;
    private CommonService mCommonService;

    @Inject
    public TravelFloatOnModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
