...
@ActivityScope
public class MainNewModel extends BaseModel<ServiceManager, CacheManager> implements MainNewContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MainNewModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
