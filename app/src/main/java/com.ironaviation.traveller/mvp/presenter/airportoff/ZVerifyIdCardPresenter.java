...
@ActivityScope
public class ZVerifyIdCardPresenter extends BasePresenter<ZVerifyIdCardContract.Model, ZVerifyIdCardContract.View> {
    ...
    @Inject
    public ZVerifyIdCardPresenter(ZVerifyIdCardContract.Model model, ZVerifyIdCardContract.View rootView
