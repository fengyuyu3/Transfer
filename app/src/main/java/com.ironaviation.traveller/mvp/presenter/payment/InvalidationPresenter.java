...
@ActivityScope
public class InvalidationPresenter extends BasePresenter<InvalidationContract.Model, InvalidationContract.View> {
    ...
    @Inject
    public InvalidationPresenter(InvalidationContract.Model model, InvalidationContract.View rootView
                    ...
                    public void onNext(BaseData<RouteStateResponse> routeStateResponseBaseData) {
                        if(routeStateResponseBaseData.isSuccess()){
                            if(routeStateResponseBaseData.getData()!= null){
                                mRootView.setRouteStateData(routeStateResponseBaseData.getData());
                            }else{
//                                mRootView.showMessage(routeStateResponseBaseData.getMessage());
                            }
                        }else{
                            mRootView.showMessage(routeStateResponseBaseData.getMessage());
                        }
